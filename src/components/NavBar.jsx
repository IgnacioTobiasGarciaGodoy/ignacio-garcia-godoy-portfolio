...
const Navbar = ({ id }) => {
  return (
    <div className="w-[70] h-full fixed left-0 top-0 flex flex-col justify-between border-r border-gray-200 px-4 py-10 z-10">
      <a href="/#home">
        <span className="text-3xl font-semibold text-sky-800">
          IGG
        </span>
        <span className="block w-min rotate-90 origin-bottom text-[12px] font-semibold text-brown"></span>
      </a>

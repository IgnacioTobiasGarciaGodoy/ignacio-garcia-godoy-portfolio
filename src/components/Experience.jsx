  ...
  return (
    <div id="experience" className="relative py-20 px-96">
      ...
      <Image
        ...
        width={800}
        height={800}
        className="absolute -top-4 right-96 scale-125 lg:hidden"
      />
        ...
        {experienceData.map((data, i) => (
          ...
          >
            <motion.div
              ...
              className="relative flex flex-col gap-y-3 rounded-md border border-sky-500 bg-white p-4 tracking-wide sm:text-sm"
            >
              ...
              <span
                className={`absolute top-20 text-sky-700 -translate-y-1/2 ${
            ...
            <div
              className={`w-14 absolute top-20 border border-gray-300 rounded-full aspect-square grid place-items-center text-sky-800 font-light -translate-y-1/2 z-10 bg-white ${
                i % 2 === 0

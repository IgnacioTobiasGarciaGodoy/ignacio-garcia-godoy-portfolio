        ...
        {experienceData.map((data, i) => (
          ...
          >
            <motion.div
              ...
              className="relative flex flex-col gap-y-3 rounded-md border border-yellow-600 bg-white p-4 tracking-wide sm:text-sm dark:bg-zinc-700 transition-colors z-20"
            >
              ...
              <span
                className={`absolute top-20 text-sky-300 -translate-y-1/2 lg:hidden ${
            ...
            <div
              className={`w-14 absolute top-20 border border-gray-300 rounded-full aspect-square grid place-items-center text-sky-600 font-light -translate-y-1/2 z-10 bg-white ${
                i % 2 === 0
